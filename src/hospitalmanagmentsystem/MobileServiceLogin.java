 ...
 * @author acer
 */
public class MobileServiceLogin extends javax.swing.JFrame {

    /**
     * Creates new form MAdminLogin
     */
    public MobileServiceLogin() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Service Manager Login");
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon("C:\\Users\\singer\\Downloads\\user_roles\\user_roles\\serviceManager.png")); // NOI18N
    ...
    private void jLoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jLoginActionPerformed
        ...
        if(password.contains("manager123") && username.contains("manager")){
            jPassword.setText(null);
            jUsername.setText(null);
            
           
            MobileServiceMain main = new MobileServiceMain();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MobileServiceLogin.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MobileServiceLogin().setVisible(true);
            }
        });
    }
